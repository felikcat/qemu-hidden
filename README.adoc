...
----
  ...
  # TSC frequency gets past RDTSC exit checks by faking a 0.6GHz CPU frequency.
  <clock offset="localtime">
    <timer name="tsc" frequency="600000000" mode="native"/>
...
=== Setup the QEMU hook for automatic: CPU isolation, 2MB hugepages, CPU performance scheduler
