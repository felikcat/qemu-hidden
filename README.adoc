...
.If your host audio stutters while the VM is running, this may fix it:
. `wget https://github.com/Viciooso/Fix-VM-Audio-Stuttering/raw/9f6f346e63a3a73b72a8d91e4e8fb3351e8b84d6/fix_vm_audio.sh`
